    ...
    <div className="student-form">
      <Form id="addStudentForm" autoComplete="off" onSubmit={handleSubmit}>
        ...
        <FormGroup>
          ...
          <Input name="name" id="name" value={student.name} type="text" placeholder="Enter a Student Name" onChange={handleInputChange} />
        </FormGroup>

        <FormGroup>
          <Label for="teacher">Teacher:</Label>
          <Input name="teacher" id="teacher" value={student.teacher} type="text" placeholder="Enter a Teacher Name" onChange={handleInputChange} />
        </FormGroup>

        <FormGroup>
          <Label for="grade">Grade:</Label>
          <Input name="grade" id="grade" value={student.grade} type="number" placeholder="Enter a Grade" onChange={handleInputChange} />
        </FormGroup>
