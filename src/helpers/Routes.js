  ...
  return (
    <div>
      <Switch>
        ...
        <PrivateRoute exact user={user} path="/students" component={() => <Students students={students} setStudents={setStudents} />} />
        <PrivateRoute user={user} path="/student/:id" component={SingleStudent} />
        <PrivateRoute path="/add-student" component={() => <AddStudent user={user} setStudents={setStudents} />} />
      </Switch>
    </div>
  );
}
