...
const addStudent = (obj) => new Promise((resolve, reject) => {
  axios
    .post(`${dbUrl}/students.json`, obj)
    .then((response) => {
      const body = { firebaseKey: response.data.name };
      axios.patch(`${dbUrl}/students/${response.data.name}.json`, body).then(() => {
...
const deleteStudent = (firebaseKey) => new Promise((resolve, reject) => {
  axios
    .delete(`${dbUrl}/students/${firebaseKey}.json`)
...
const updateStudent = (student) => new Promise((resolve, reject) => {
  axios
    .patch(`${dbUrl}/students/${student.firebaseKey}.json`, student)
...
const getSingleStudent = (firebaseKey) => new Promise((resolve, reject) => {
  axios
    .get(`${dbUrl}/students/${firebaseKey}.json`)
